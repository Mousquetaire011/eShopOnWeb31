...
namespace Microsoft.eShopWeb.Web.Pages.Admin
{
    ...
    public class ProductsModel : PageModel
    {
        ...
        public async Task OnGet(CatalogProductsViewModel catalogModel, int? pageId)
        {
            ...
            CatalogModel = await _catalogViewModelService.GetCatalogItems(pageId.GetValueOrDefault(), Constants.ITEMS_PER_PAGE, catalogModel.BrandFilterApplied, catalogModel.TypesFilterApplied).ConfigureAwait(true);
        }
    }
}
